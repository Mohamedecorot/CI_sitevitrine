...
class Produits extends CI_Controller
{
	...
	public function __construct()
	{
        ...
        $this->load->model('livreor_model', 'produitManager');
...
// ------------------------------------------------------------------------
    ...
    public function voir($g_nb_commentaire = 1)
    {
        ...
        $nb_commentaire_total = $this->produitManager->count();
        ...
        $data['messages'] = $this->produitManager->get_commentaires(self::NB_COMMENTAIRE_PAR_PAGE, $nb_commentaire-1);
