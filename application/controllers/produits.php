...
class Produits extends CI_Controller
{
	...
	public function __construct()
	{
        ...
        $this->load->model('produits_model', 'produitManager');
...
// ------------------------------------------------------------------------
    ...
    public function voir()
    {
        ...
        //	On lance la requête récupérant les produits dans la base de données.
        $data['produit'] = $this->produitManager->get_produits();

        //	On charge la vue
        $this->load->view('produit/afficher_produit', $data);
    }
...
// ------------------------------------------------------------------------
    ...
    public function ecrire()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            $this->produitManager->ajouter_commentaire($this->input->post('pseudo'),
